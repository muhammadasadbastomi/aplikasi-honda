...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <a href="{{ route('admin.penjualanDetail.create', $penjualan->id) }}"
                class="btn btn-primary px-3 radius-30">Tambah Data</a>
            <div class="btn-group">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end" px-3 radius-30>
                    <a class="dropdown-item" href="{{ route('admin.report.penjualanOne', $penjualan->id) }}">Cetak
                        Data</a>
                </div>
            </div>
            {{-- <div class="btn-group">
