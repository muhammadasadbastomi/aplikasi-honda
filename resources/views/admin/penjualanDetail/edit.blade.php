    ...
    <div class="card-body">
         ...
         <div class="row">
            <div class="mb-3 col">
                ...
                <select name="sparepart_id" id="" class="form-select form-select-sm mb-3" required>
                    ...
                    <option value="{{$d->id}}" {{$penjualanDetail->sparepart_id ==  $d->id ? 'selected' : ''}}>{{$d->partNumber}} - {{$d->deskripsi}}</option>
                    @endforeach
                </select>
            </div>
            <div class="mb-3 col">
                ...
                <select name="rak_id" id="" class="form-select form-select-sm mb-3" required>
                    ...
                    <option value="{{$d->id}}" {{$penjualanDetail->rak_id ==  $d->id ? 'selected' : ''}}>{{$d->kodeLokasi}} - {{$d->gudang}}</option>
                    @endforeach
                </select>
            </div>
        </div>
        <div class="row">
            <div class="mb-3 col">
                ...
                <input class="form-control form-control-sm mb-3" type="number" name="hargaBeli" value="{{$penjualanDetail->hargaBeli}}" placeholder="Harga Beli/Pcs" aria-label="default input example" required>
            </div>
            <div class="mb-3 col">
                <label for="formFile" class="form-label">Quantity</label>
                <input class="form-control form-control-sm mb-3" type="number" name="jumlahSj" value="{{$penjualanDetail->jumlahSj}}" placeholder="Quantity" aria-label="default input example" required>
            </div>
            <div class="mb-3 col">
                <label for="formFile" class="form-label">Harga Jual/Pcs</label>
                <input class="form-control form-control-sm mb-3" type="number" name="hargaJual" value="{{$penjualanDetail->hargaJual}}" placeholder="Harga Jual/Pcs" aria-label="default input example" required>
            </div>
        </div>
    </div>
