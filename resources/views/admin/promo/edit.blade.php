...
@section('content')
    ...
    <!--end breadcrumb-->
    <h6 class="mb-0 text-uppercase">Edit Data Promo</h6>
    <hr>
    <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" value="{{ $promo->judul }}"
                            name="judul" placeholder="Judul" aria-label="default input example" required>
                    </div>
                ...
                <div class="row">
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="date" value="{{ $promo->tanggalMulai }}"
                            name="tanggalMulai" placeholder="Tanggal Mulai" aria-label="default input example" required>
                    </div>
                </div>
                <div class="row">
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="date"
                            value="{{ $promo->tanggalSelesai }}" name="tanggalSelesai" placeholder="Tanggal Selesai"
                ...
                <div class="row">
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="number" value="{{ $promo->diskon }}"
                            name="diskon" placeholder="Jumlah Diskon (%)" aria-label="default input example" required>
                    </div>
                </div>
            </div>
