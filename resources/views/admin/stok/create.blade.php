...
@section('content')
    ...
    <!--end breadcrumb-->
    <h6 class="mb-0 text-uppercase">Tambah Data Stok</h6>
    <hr>
    <div class="card">
        <form action="{{ route('admin.stok.store') }}" method="post" enctype="multipart/form-data">
            <div class="card-body">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control form-control-sm mb-3" type="date" name="tanggalStok"
                        placeholder="Tanggal Stok" aria-label="default input example" required>
                </div>
                <div class="mb-3">
