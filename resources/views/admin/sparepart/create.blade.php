            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="partNumber"
                            placeholder="Part Number" aria-label="default input example" required>
                    </div>
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="deskripsi"
                            placeholder="Deskripsi" aria-label="default input example" required>
                    </div>
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="partReference"
                            placeholder="Part Reference" aria-label="default input example" required>
                    </div>
                </div>
                <div class="row">
                    {{-- <div class="mb-3 col">
                    ...
                    {{-- <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="kodeGroupSales"
                ...
                <div class="row">
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="HET" placeholder="HET"
                    ...
                    {{-- <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="partNumberType"
                            placeholder="part Number Type" id="formFile" required>
                    </div> --}}
                    {{-- <div class="mb-3 col">
                ...
                {{-- <div class="row">
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="partMoving"
                            placeholder="part Moving" id="formFile" required>
                    </div>
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="partSource"
                            placeholder="partSource" id="formFile" required>
                    </div>
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="partCurrent"
                            placeholder="part Current" id="formFile" required>
                    </div>
                </div> --}}
                {{-- <div class="row">
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="partType"
                            placeholder="part Type" id="formFile" required>
                    </div>
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="partLifetime"
                            placeholder="part Lifetime" id="formFile" required>
                    </div>
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="partGroup"
                            placeholder="partGroup" id="formFile" required>
                    </div>
                </div> --}}
            </div>
