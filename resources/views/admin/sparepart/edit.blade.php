        ...
        <form action="{{ route('admin.sparepart.update', $sparepart->id) }}" method="post" enctype="multipart/form-data">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="partNumber"
                            value="{{ $sparepart->partNumber }}" placeholder="Part Number"
                            aria-label="default input example" required>
                    </div>
                    <div class="mb-3 col">
                        <label for="formFile" class="form-label">Deskripsi Part</label>
                        <input class="form-control form-control-sm mb-3" type="text" name="deskripsi"
                            value="{{ $sparepart->deskripsi }}" placeholder="Deskripsi" aria-label="default input example"
                            required>
                    </div>
                    <div class="mb-3 col">
                        <label for="formFile" class="form-label">Part Reference</label>
                        <input class="form-control form-control-sm mb-3" type="text" name="partReference"
                            value="{{ $sparepart->partReference }}" placeholder="Part Reference"
                            aria-label="default input example" required>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="mb-3 col">
                    ...
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="partStatus"
                            value="{{ $sparepart->partStatus }}" placeholder="part Status"
                            aria-label="default input example" required>
                    </div>
                </div>
                <div class="row">
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="HET"
                            value="{{ $sparepart->HET }}" placeholder="HET" aria-label="default input example" required>
                    </div>
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="hargaPokok"
                            value="{{ $sparepart->hargaPokok }}" placeholder="harga Pokok" id="formFile" required>
                    </div>
                    {{-- <div class="mb-3 col">
                    ...
                    {{-- <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="partNumberType"
                            value="{{ $sparepart->partNumberType }}" placeholder="part Number Type" id="formFile" required>
                    </div> --}}
                </div>
                {{-- <div class="row">
                <div class="mb-3 col">
                ...
                {{-- <div class="row">
                    <div class="mb-3 col">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="partMoving"
                            value="{{ $sparepart->partMoving }}" placeholder="part Moving" id="formFile" required>
                    </div>
                    <div class="mb-3 col">
                        <label for="formFile" class="form-label">part Source</label>
                        <input class="form-control form-control-sm mb-3" type="text" name="partSource"
                            value="{{ $sparepart->partSource }}" placeholder="partSource" id="formFile" required>
                    </div>
                    <div class="mb-3 col">
                        <label for="formFile" class="form-label">part Current</label>
                        <input class="form-control form-control-sm mb-3" type="text" name="partCurrent"
                            value="{{ $sparepart->partCurrent }}" placeholder="part Current" id="formFile" required>
                    </div>
                </div>
                <div class="row">
                    <div class="mb-3 col">
                        <label for="formFile" class="form-label">part Type</label>
                        <input class="form-control form-control-sm mb-3" type="text" name="partType"
                            value="{{ $sparepart->partType }}" placeholder="part Type" id="formFile" required>
                    </div>
                    <div class="mb-3 col">
                        <label for="formFile" class="form-label">part Lifetime</label>
                        <input class="form-control form-control-sm mb-3" type="text" name="partLifetime"
                            value="{{ $sparepart->partLifetime }}" placeholder="part Lifetime" id="formFile" required>
                    </div>
                    <div class="mb-3 col">
                        <label for="formFile" class="form-label">part Group</label>
                        <input class="form-control form-control-sm mb-3" type="text" name="partGroup"
                            value="{{ $sparepart->partGroup }}" placeholder="partGroup" id="formFile" required>
                    </div>
                </div> --}}
            </div>
            ...
            <div class="card-footer text-end">
                <button type="submit" class="btn btn-primary px-3 radius-30"><i class="bi bi-save2-fill"></i>
                    Simpan</button>
                <a href="{{ route('admin.sparepart.index') }}" class="btn btn-danger px-3 radius-30"><i
