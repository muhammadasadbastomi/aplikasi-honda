            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control form-control-sm mb-3" type="text" name="noTransaksi"
                        value="{{ $penjualan->noTransaksi }}" placeholder="No Transaksi" aria-label="default input example"
                        required readonly>
                </div>
                <div class="mb-3">
                    ...
                    <input class="form-control form-control-sm mb-3" type="date" name="tanggalpenjualan"
                        value="{{ $penjualan->tanggalpenjualan }}" placeholder="Tanggal penjualan"
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control form-control-sm mb-3" type="text" name="noFaktur"
                        value="{{ $penjualan->noFaktur }}" placeholder="no Faktur" aria-label="default input example"
                        required>
                </div>
            </div>
