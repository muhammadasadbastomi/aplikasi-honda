...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <input class="form-control form-control-sm mb-3" type="date" name="tanggalPenjualan" placeholder="Tanggal penjualan" aria-label="default input example" required>
        </div>
        <div class="mb-3">
            <label for="formFile" class="form-label">Nama Customer</label>
            <input class="form-control form-control-sm mb-3" type="text" name="namaCustomer" placeholder="Nama Customer" aria-label="default input example" required>
        </div>
    </div>
