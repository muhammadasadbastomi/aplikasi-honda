...
<hr>
<div class="card">
    <form action="{{route('admin.pembelianDetail.update',$pembelian->id)}}" method="post" enctype="multipart/form-data">
    <div class="card-body">
            @csrf
            @method('put')
        <div class="mb-3">
    ...
    <div class="card-footer text-end">
        ...
        <a href="{{route('admin.pembelianDetail.index')}}" class="btn btn-danger px-3 radius-30"><i class="bi bi-backspace-fill"></i> Batal</a>
    </div>
