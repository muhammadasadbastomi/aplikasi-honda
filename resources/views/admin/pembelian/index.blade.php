                                ...
                                <tbody>
                                    @foreach ($data as $d)
                                        <tr>
                                            ...
                                            <td>{{ carbon\carbon::parse($d->tanggalPembelian)->translatedFormat('d F Y') }}
                                            </td>
                                            <td>{{ $d->noTransaksi }}</td>
                                            <td>{{ $d->noFaktur }}</td>
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{ route('admin.pembelian.show', $d->id) }}"
                                                        class="btn btn-primary"><i class="bi bi-eye-fill"></i></a>
                                                    <a href="{{ route('admin.pembelian.edit', $d->id) }}"
                                                        class="btn btn-primary"><i class="bi bi-pencil-square"></i></a>
                                                    <button type="button" class="btn btn-danger destroy"
                                                        data-bs-toggle="modal"
                                                        data-route="{{ route('admin.pembelian.destroy', $d->id) }}"
