...
<!--end breadcrumb-->
<h6 class="mb-0 text-uppercase">Tambah Data Pembelian</h6>
<hr>
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <input class="form-control form-control-sm mb-3" type="date" name="tanggalPembelian" placeholder="Tanggal Pembelian" aria-label="default input example" required>
        </div>
        <div class="mb-3">
