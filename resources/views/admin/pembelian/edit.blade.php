            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control form-control-sm mb-3" type="text" name="noTransaksi"
                        value="{{ $pembelian->noTransaksi }}" placeholder="No Transaksi" aria-label="default input example"
                        required readonly>
                </div>
                <div class="mb-3">
                    ...
                    <input class="form-control form-control-sm mb-3" type="date" name="tanggalPembelian"
                        value="{{ $pembelian->tanggalPembelian }}" placeholder="Tanggal Penerimaan"
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control form-control-sm mb-3" type="text" name="noFaktur"
                        value="{{ $pembelian->noFaktur }}" placeholder="no Faktur" aria-label="default input example"
                        required>
                </div>
            </div>
