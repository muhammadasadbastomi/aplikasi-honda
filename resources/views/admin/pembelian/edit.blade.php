...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <input class="form-control form-control-sm mb-3" type="date" name="tanggalPembelian" value="{{$pembelian->tanggalPembelian}}" placeholder="Tanggal Penerimaan" aria-label="default input example" required>
        </div>
        <div class="mb-3">
